  ...
  store,
    ...
    export type GetBlogPostDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["BlogPost"]["doits"]["getBlogPost"]["details"];
...
export const getBlogPost: GetBlogPost = async ({ set, get }, token = ""
