  ...
  store,
    ...
    export type GetBlogTagDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["BlogTag"]["doits"]["getBlogTag"]["details"];
...
export const getBlogTag: GetBlogTag = async ({ set, get }, token = ""
