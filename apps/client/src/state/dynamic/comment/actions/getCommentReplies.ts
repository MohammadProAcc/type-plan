  ...
  store,
    ...
    export type GetCommentRepliesDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["Comment"]["doits"]["getCommentReplies"]["details"];

type  GetCommentReplies = (
  {}: GetCommentRepliesDetails,
  token: string,
) => Promise<Response<FQl_response_comment_IComment>>;
    
          
    
export const getCommentReplies: GetCommentReplies = async ({ set, get }, token = ""
