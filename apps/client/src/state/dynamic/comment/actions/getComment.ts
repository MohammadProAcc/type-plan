  ...
  store,
    ...
    export type GetCommentDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["Comment"]["doits"]["getComment"]["details"];
...
export const getComment: GetComment = async ({ set, get }, token = ""
