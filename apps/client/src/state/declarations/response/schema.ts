        ...
        models: {
          User: {
            doits: {
              loginRequest: {
                details: {
                  response: FQl_response_loginRequest_LoginRequestReturn;
                };
              };
          ...
          BlogPost: {
            doits: {
              ...
              getBlogPosts: {
                details: {
                  response: Partial<FQl_response_blogPost_IBlogPost>[];
                };
              };
              switchBlogPostLike: {
                details: { response: Partial<FQl_response_blogPost_IBlogPost> };
          ...
          ContactUs: {
            doits: {
              createContactUs: {
                details: {
                  response: Partial<FQl_response_contactUs_IContactUs>;
                };
              };
              deleteContactUs: {
                details: {
        ...
        models: {
          ...
          StoreHomePage: {
            doits: {
              ...
              addToStoreHomePageSlider: { details: { response: any } };
            };
          };
        };
      };
      streams: {
        models: {
          File: {
            doits: {
              uploadFile: {
                details: { response: Partial<FQl_response_upload_IFile> };
              };
              uploadPdf: {
                details: { response: Partial<FQl_response_upload_IFile> };
              };
    ...
    contents: {
      dynamic: {
        models: {
          User: {
            doits: {
              loginRequest: FQl_response_loginRequest_LoginRequestReturn;
              ...
              getMe: Partial<FQl_response_user_IUser>;
          ...
          BlogTag: {
            doits: {
              createBlogTag: Partial<FQl_response_blogTag_IBlogTag>;
          ...
          BlogCategory: {
            doits: {
              createBlogCategory: Partial<
                FQl_response_blogCategory_IBlogCategory
              >;
              updateBlogCategory: Partial<
                FQl_response_blogCategory_IBlogCategory
              >;
              deleteBlogCategory: Partial<
                FQl_response_blogCategory_IBlogCategory
              >;
              getBlogCategory: Partial<FQl_response_blogCategory_IBlogCategory>;
              getBlogCategories: Partial<
                FQl_response_blogCategory_IBlogCategory
              >[];
            };
          };
          ...
          ContactUs: {
            doits: {
              createContactUs: Partial<FQl_response_contactUs_IContactUs>;
              deleteContactUs: Partial<FQl_response_contactUs_IContactUs>;
              getContactUs: Partial<FQl_response_contactUs_IContactUs>;
              getContactUss: Partial<FQl_response_blogTag_IBlogTag>[];
            };
          };
          Plan: {
            doits: {
      ...
      static: {
        models: {
          ...
          StoreHomePage: {
            doits: {
              getStoreHomePage: FQl_response_types_StoreHomePage;
              addToStoreHomePageSlider: any;
            };
          };
        };
      };
      streams: {
        models: {
          File: {
            doits: {
              uploadFile: Partial<FQl_response_upload_IFile>;
              uploadPdf: Partial<FQl_response_upload_IFile>;
              downloadFile: any;
            };
          };
        };
...
export interface FQl_response_plan_IPlan {
  ...
  photo: FQl_response_upload_PuFile;
  pdf: FQl_response_upload_PuFile;
  slider: FQl_response_upload_PuFile[];
  _id: string;
  createdAt?: Date;
  updateAt?: Date;
}
