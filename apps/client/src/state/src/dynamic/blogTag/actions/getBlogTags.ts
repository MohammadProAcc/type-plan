  ...
  store,
    ...
    export type GetBlogTagsDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["BlogTag"]["doits"]["getBlogTags"]["details"];
...
export const getBlogTags: GetBlogTags = async ({ set, get }, token = ""
