  ...
  store,
    ...
    export type UpdateBlogPostDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["BlogPost"]["doits"]["updateBlogPost"]["details"];
...
export const updateBlogPost: UpdateBlogPost = async ({ set, get }, token = ""
