  ...
  store,
    ...
    export type CreateContactUsDetails =
  FunQLRequest["schema"]["contents"]["dynamic"]["models"]["ContactUs"]["doits"]["createContactUs"]["details"];
...
export const createContactUs: CreateContactUs = async ({ set, get }, token = ""
